...
@section('content')
        ...
        <div class="breadcrumb-area bg-light">
            <div class="container-fluid">
                <div class="breadcrumb-content text-center">
                    <h1 class="title">Single Product Gallery</h1>
                    <ul>
                        <li>
                            <a href="index.html">Home </a>
                        </li>
                        <li class="active"> Single Product Gallery</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="section section-margin">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-0 col-md-8 offset-md-2 col-custom order-md-1 order-lg-2">

                    <!-- Product Details Gallery Image Start -->
                    <div class="product-details-img">
                        <div class="gallery-image popup-gallery row mb-n6">
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="assets/images/products/large-size/1.jpg">
                                <img class="w-100 border" src="assets/images/products/large-size/1.jpg" alt="Product">
                            </a>
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="assets/images/products/large-size/2.jpg">
                                <img class="w-100 border" src="assets/images/products/large-size/2.jpg" alt="Product">
                            </a>
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="assets/images/products/large-size/3.jpg">
                                <img class="w-100 border" src="assets/images/products/large-size/3.jpg" alt="Product">
                            </a>
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="assets/images/products/large-size/4.jpg">
                                <img class="w-100 border" src="assets/images/products/large-size/4.jpg" alt="Product">
                            </a>
                        </div>
                    </div>
                    <!-- Product Details Gallery Image End -->

                </div>
                <div class="col-lg-6 col-custom order-md-2 order-lg-1">
