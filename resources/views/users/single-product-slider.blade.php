        ...
        <div class="breadcrumb-area bg-light">
            <div class="container-fluid">
                <div class="breadcrumb-content text-center">
                    <h1 class="title">Single Product Slider</h1>
                    <ul>
                        <li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="product-carousel single-product-slider">

                        <!-- Single Product Image Start -->
                        <div class="swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide product product-border-left" href="assets/images/products/large-size/1.jpg">
                                    <img class="w-100" src="assets/images/products/large-size/1.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="assets/images/products/large-size/2.jpg">
                                    <img class="w-100" src="assets/images/products/large-size/2.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="assets/images/products/large-size/3.jpg">
                                    <img class="w-100" src="assets/images/products/large-size/3.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="assets/images/products/large-size/4.jpg">
                                    <img class="w-100" src="assets/images/products/large-size/4.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="assets/images/products/large-size/5.jpg">
                                    <img class="w-100" src="assets/images/products/large-size/5.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="assets/images/products/large-size/6.jpg">
                ...
                <div class="col-md-6 m-auto col-12">
                    ...
                    <div class="product-summery position-relative text-center product-slider-summery mt-0 pt-10">
                        ...
                        <!-- Rating Start -->
                        <span class="ratings justify-content-center">
                        ...
                        <!-- Quantity Start -->
                        <div class="quantity mb-5 d-flex justify-content-center">
                        ...
                        <div class="cart-wishlist-btn mb-4 d-flex justify-content-center">
