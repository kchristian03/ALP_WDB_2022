            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-2 col-6">
                    <div class="header-logo">
                        <a href="/"><img src="{{asset("assets/media/images/logo/logo.png")}}" alt="Site Logo"/></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                                ...
                                <ul class="mega-menu row-cols-4">
                                    <li class="col">
                                        ...
                                        <ul class="mb-n2">
                                            ...
                                            <li><a href="/shop-left-sidebar">Left Sidebar</a></li>
                                            <li><a href="/shop-right-sidebar">Right Sidebar</a></li>
                                            <li><a href="/shop-list-fullwidth">List Fullwidth</a></li>
                                            <li><a href="/shop-list-left-sidebar">List Left Sidebar</a></li>
                                            <li><a href="/shop-list-right-sidebar">List Right Sidebar</a></li>
                                        </ul>
                                    </li>
                                    <li class="col">
                ...
                <div class="col-xl-2 col-6">
                    <div class="header-actions">
                        ...
                        <a href="/login-register" class="header-action-btn d-none d-md-block"><i class="pe-7s-user"></i></a>
