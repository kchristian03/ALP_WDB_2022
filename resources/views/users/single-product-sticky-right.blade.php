...
@section('content')
        ...
        <div class="breadcrumb-area bg-light">
            <div class="container-fluid">
                <div class="breadcrumb-content text-center">
                    <h1 class="title">Single Product Sticky</h1>
                    <ul>
                        <li>
                            <a href="index.html">Home </a>
                        </li>
                        <li class="active"> Single Product Sticky</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="section section-margin">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 offset-lg-0 col-md-8 offset-md-2 col-custom order-md-1 order-lg-2">

                    <!-- Product Details Image Start -->
                    <div class="product-details-sticky-img">

                        <!-- Single Product Image Start -->
                        <div class="popup-gallery mb-n6">
                            <a class="mb-6 d-block" href="assets/images/products/large-size/1.jpg">
                                <img class="w-100" src="assets/images/products/large-size/1.jpg" alt="Product">
                            </a>
                            <a class="mb-6 d-block" href="assets/images/products/large-size/2.jpg">
                                <img class="w-100" src="assets/images/products/large-size/2.jpg" alt="Product">
                            </a>
                            <a class="mb-6 d-block" href="assets/images/products/large-size/3.jpg">
                                <img class="w-100" src="assets/images/products/large-size/3.jpg" alt="Product">
                            </a>
                            <a class="mb-6 d-block" href="assets/images/products/large-size/4.jpg">
                ...
                <div class="col-lg-7 col-custom order-md-2 order-lg-1" id="sticky-sidebar">
