                            ...
                            <div class="widget-list">
                                ...
                                <div class="sidebar-body product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        ...
                                        <div class="content">
                                            <h5 class="title"><a href="/single-product">Brother Hoddies in Grey</a></h5>
                                            <span class="price">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        ...
                                        <div class="content">
                                            <h5 class="title"><a href="/single-product">Basic Jogging Shorts</a></h5>
                                            <span class="price">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        ...
                                        <div class="content">
                                            <h5 class="title"><a href="/single-product">Simple Woven Fabrics</a></h5>
                                            <span class="price">
